...
- How does the feature preserve uncertainty, dissent, and minority viewpoints?
- How does the feature prevent consensus from being presented as proof of truth?
- How are secrets, provider keys, transcripts, and logs protected?
- If npm packages are introduced, what vulnerability database/check validates
  the chosen package versions before adoption?
- What user-visible limits or verification guidance are needed for high-stakes
  domains?
